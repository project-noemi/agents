...
| Date | PR | Model | Gate | Reviewer said | Human did | Direction | Reason |
|---|---|---|---|---|---|---|---|
| 2026-08-26 | #457 | publishers/google/models/gemini-3.1-pro-preview | framing | framing fail: The PR description claims 'No new questions raised' and that the backlog is 'unchanged', but the diff against the base branch (`develop`) in | **merged over** | PENDING-HUMAN | PENDING-HUMAN — edit this row, then approve |
