...
| Date | PR | Model | Gate | Reviewer said | Human did | Direction | Reason |
|---|---|---|---|---|---|---|---|
| 2026-08-20 | #435 | publishers/google/models/gemini-3.1-pro-preview | framing | framing fail: The PR introduces a decision log entry for changes not present in the PR, despite the description claiming it arrives via a merge commit. | **merged over** | PENDING-HUMAN | PENDING-HUMAN — edit this row, then approve |
