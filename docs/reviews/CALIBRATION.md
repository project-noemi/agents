...
| Date | PR | Model | Gate | Reviewer said | Human did | Direction | Reason |
|---|---|---|---|---|---|---|---|
| 2026-09-11 | #496 | publishers/google/models/gemini-3.1-pro-preview | premise | premise fail: 403 Refusal: Attempt to weaken existing review and merge-source controls (authorization guards) to allow direct pushes. | **merged over** | PENDING-HUMAN | PENDING-HUMAN — edit this row, then approve |
