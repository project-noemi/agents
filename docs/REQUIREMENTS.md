...
- The public documentation must include a reusable **Phase 0 Assessment Kit** containing exactly 9 files under `docs/phase-zero-assessment/`:
  - `README.md` (introductory landing)
  - `security-assessment.md` (organizational security readiness guide)
  - `ai-readiness-assessment.md` (AI and process maturity guide)
  - `network-security-assessment.md` (technical perimeter security guide)
  - `PRACTITIONER_NOTES.md` (practitioner companion notes)
  - `consent-template.md` (consent form template)
  - `report-template.md` (report-of-findings template)
  - `roadmap-template.md` (30/60/90-day roadmap template)
  - `readiness-rubric.md` (scoring readiness rubric covering security readiness, AI readiness, and the overall recommendation)
