...
- **Testing Toolchain Drift**: `tools/executive-assistant/package.json` utilizes `vitest` for tests, representing a testing framework drift from the root-level native Node.js test runner.
