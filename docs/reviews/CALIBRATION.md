...
| Date | PR | Model | Gate | Reviewer said | Human did | Direction | Reason |
|---|---|---|---|---|---|---|---|
| 2026-08-20 | #443 | publishers/google/models/gemini-3.1-pro-preview | framing | framing fail: The PR claims to replace global fetch with https.request to fix the 5-minute timeout, but the implementation defaults to using fetch. | **merged over** | PENDING-HUMAN | PENDING-HUMAN — edit this row, then approve |
