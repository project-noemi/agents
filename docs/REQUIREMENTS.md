...
- **RFP Split Naming Convention Drift** (Remediated: 2026-06-01): Verified that assets in `examples/rfp-split/` follow the English-first, slug-based naming convention.
...
- **Memory-Code Synchronization Drift** (Identified: 2026-06-01): Recorded remediations for sync script, agent index, and shared `audit_logger.js` are absent from the filesystem despite being documented as complete in architectural memory.
