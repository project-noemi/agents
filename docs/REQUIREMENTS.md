...
- **Red Team Gauntlet Test Vectors Pending**: Decision [2026-06-12-0003] mandates a starter `examples/red-team-gauntlet/test-vectors.yaml` with the five Client Onboarding cases. Pending implementation.
