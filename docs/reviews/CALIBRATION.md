...
| Date | PR | Model | Gate | Reviewer said | Human did | Direction | Reason |
|---|---|---|---|---|---|---|---|
| 2026-09-08 | #480 | publishers/google/models/gemini-3.1-pro-preview | premise | premise fail: The PR introduces unnecessary, repetitive changes by appending daily execution logs to Markdown documentation. | **merged over** | PENDING-HUMAN | PENDING-HUMAN — edit this row, then approve |
