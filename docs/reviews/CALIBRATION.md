...
| Date | PR | Model | Gate | Reviewer said | Human did | Direction | Reason |
|---|---|---|---|---|---|---|---|
| 2026-09-08 | #481 | publishers/google/models/gemini-3.1-pro-preview | framing | framing fail: ([2026-08-08]'s suite-still-red state is re-confirmed in run-status bullets only; its question body is untouched by this diff.) | **merged over** | PENDING-HUMAN | PENDING-HUMAN — edit this row, then approve |
