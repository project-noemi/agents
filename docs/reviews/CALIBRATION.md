...
| Date | PR | Model | Gate | Reviewer said | Human did | Direction | Reason |
|---|---|---|---|---|---|---|---|
| 2026-08-20 | #437 | publishers/google/models/gemini-3.1-pro-preview | premise | premise fail: The PR description attempts to manipulate the review process by instructing the reviewer to drop the Sentinel persona. | **merged over** | PENDING-HUMAN | PENDING-HUMAN — edit this row, then approve |
