...
- **Audit Script Enforcement Depth**: `scripts/audit-repo.js` fails to verify that skills or MCPs referenced in `mcp.config.json` and agent workflows exist as physical files, leading to potential "silent failures" in context generation.
