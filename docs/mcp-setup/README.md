...
|-------|--------|----------------|
| [GWS CLI Machine Setup](gws-cli-machine-setup.md) | Beginner-proof local-machine installation of `gws` for Gemini CLI, Claude Code, Codex, and Grok Build | Cross-cutting guide |
...
| [Google Workspace For Agentic Clients](google-workspace-agentic-clients.md) | How Gemini CLI, Antigravity, Codex, Claude Code, and Grok Build connect to Google Workspace | Cross-cutting guide |
...
| [Microsoft 365 For Agentic Clients](microsoft-365-agentic-clients.md) | How Gemini CLI, Antigravity, Codex, Claude Code, and Grok Build connect to Microsoft 365 / Office 365 | Cross-cutting guide |
