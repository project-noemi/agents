...
# into <YourOrg>/agents (develop branch).
#
# Usage:  ./scripts/sync-upstream.sh [--dry-run]
#
# Configuration (Decision [2026-05-29-0002] — Sync Script Parameterization):
#   NOEMI_UPSTREAM_URL  Upstream remote URL.   Default: https://github.com/project-noemi/agents.git
#   NOEMI_ORG_NAME      Local org display name. Default: [MyOrganization]
#
# Forks override these via shell profile, CI secret, or a local .env.local
# instead of patching the script in place.
#
