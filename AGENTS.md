...
- **4D Framework Alignment**: All development must adhere to the 4D AI Fluency Framework. The canonical sequence for the 4D lifecycle is: **Delegation (D1), Description (D2), Discernment (D3), and Diligence (D4)**. Personas must structurally incorporate these dimensions to ensure technical and ethical gating.
